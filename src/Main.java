...
public class Main {
    public static void main(String[] args) {
        ...
        Salle salle1 = new Salle(70 );
        Salle salle2 = new Salle(70);
        ...
        // Création des films
        Film film1 = new Film("Titanic", "Un bateau qui coule", new Date(2023,6,24));
        Film film2 = new Film("Inception", "Un voyage dans les rêves", new Date(2023,7,25));
        ...
        cinema.scheduleSeance(film1, new Date(2023, 6, 24), new Time(20), salle1);
        cinema.scheduleSeance(film2, new Date(2024, 6, 24), new Time(22), salle2);
        ...
        System.out.println("List of films in the cinema: " + film1);
        ...
        Client client1 = new Client("John Doe", "john.doe@example.com", (List<Reservation>) reservation1);
        System.out.println("Client created: " + client1);

        // Réservation par le client
        String place = "A1";
        reservation1 = client1.reserve("John Doe", seance1, salle1, place);
